...
public class Playfair {
    ...
    //  функція видалення повторюваних символів із ключа
    ...
    // функція для створення таблиці ключів шифру playfair
    public void generateCipherKey()
    {
        ...
        // видалити повторювані символи з ключа шифру
        ...
        // створити таблицю ключів шифру
        for (int i = 0, idx = 0; i < 5; i++)
            for (int j = 0; j < 5; j++)
                matrix[i][j] = tempKey.charAt(idx++);

        System.out.println("Матриця ключів шифру Playfair:");

        for (int i = 0; i < 5; i++)
            System.out.println(Arrays.toString(matrix[i]));
    }

    // функція попередньої обробки відкритого тексту
    public String formatPlainText()
    {
        ...
        for (int i = 0; i < len; i++)
        {
            // якщо відкритий текст містить символ 'j',
            // замінити на "i"
        ...
        // якщо два послідовних символи однакові, тоді
        // вставити між ними символ 'x'
        ...
        // зробити відкритий текст рівномірної довжини
        if (len % 2 == 1)
            message += 'x'; // підстановка
